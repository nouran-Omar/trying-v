  ...
  return (<>
    <footer className=" pt-24 pb-10 border-t border-gray-100 relative overflow-hidden ">
        ...
        <div className="flex flex-col items-center mb-24 relative z-10 bg-[#FAFAFA] font-inter">
           ...
           <p className=" w-lg text-[16px] text-center text-gray-text-dim2 font-medium m-5 p-5">Join thousands of patients who have improved their heart health with Pulse AI</p>
           <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-24 text-center">
             <div>
               ...
               <p className="text-[16px] text-gray-text-dim2 font-medium">Success Rate</p>
             </div>
             <div>
               <p className="text-[36px] font-bold text-[#333CF5] mb-1">10K+</p>
               <p className="text-[16px] text-gray-text-dim2 font-medium">Patients Helped</p>
             </div>
             <div>
               <p className="text-[36px] font-bold text-[#333CF5] mb-1">24/7</p>
               <p className="text-[16px] text-gray-text-dim2 font-medium">Support Available</p>
             </div>
             <div>
               <p className="text-[36px] font-bold text-[#333CF5] mb-1">50+</p>
               <p className="text-[16px] text-gray-text-dim2 font-medium">Expert Doctors</p>
             </div>
           </div>
        </div>
...
<footer className="pt-24 pb-10 border-t border-gray-100 relative overflow-hidden bg-white shadow-5xl">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4">
              {['Home', 'About', 'Contact Us'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-[16px] text-gray-text-dim2 hover:text-[#333CF5] transition-colors font-medium">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="flex flex-col max-w-7xl mx-auto px-4  bg-white   md:flex-row justify-between items-end border-t border-gray-100 pt-8 gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="mailto:support@pulseX.health" className="text-[16px] text-gray-text-dim2 hover:text-[#333CF5] transition-colors flex items-center gap-2">
